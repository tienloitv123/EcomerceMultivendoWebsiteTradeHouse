        ...
        <div class="row no-gutters">
            <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center">
                <div class="product-slide" style="padding: 10px; background-color: #ffffff; border: 2px solid #e0e0e0;">
                    <img src="/images/products/{{ $product->product_image }}" alt="{{ $product->name }}" class="img-fluid" style="max-width: 100%; height: 600px; object-fit: contain;" />
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                <div class="product-detail-desc pd-20 card-box height-100-p" style="margin-left: -2px;">
                    ...
                    <div class="mx-w-150 mt-3">
                        <div class="form-group">
                            <label class="text-blue">Quantity</label>
                            <input id="quantity" type="number" value="1" name="quantity" min="1" max="10" class="form-control" />
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="product-box">
                            <div class="product-img">
                                <a href="{{ route('product.detail', ['id' => $relatedProduct->id]) }}">
                                    <img src="/images/products/{{ $relatedProduct->product_image }}" alt="{{ $relatedProduct->name }}" class="img-fluid" style="max-height: 200px; object-fit: contain;">
                                </a>
                            </div>
                            <div class="product-caption">
                                <h4><a href="{{ route('product.detail', ['id' => $relatedProduct->id]) }}">{{ $relatedProduct->name }}</a></h4>
                                <div class="price">
                                ...
                                <a href="{{ route('product.detail', ['id' => $relatedProduct->id]) }}" class="btn btn-outline-primary btn-sm mt-2">Read More</a>
                            </div>
                        </div>
                    </li>
                @empty
