            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-90" src="/front/images/banner1.png" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-90" src="/front/images/banner2.png" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-90" src="/front/images/banner3.png" alt="Third slide">
                    </div>
                </div>
            </div>
            ...
            <div class="row g-sm-4 g-3">
                                    ...
                                    @foreach (get_categories() as $category)
                                        <li>
                                            <div class="category-list">
                                                ...
                                                <img href="{{ route('category.search', $category->id) }}"
                                                    src="/images/categories/{{ $category->category_image }}"
                                                    class="lazyload" alt="{{ $category->category_name }}">
                                                <h5>
                                                    <a
                                                        href="{{ route('category.search', $category->id) }} javascript:void(0)">{{ $category->category_name }}</a>
                                                </h5>
                                            </div>
                                        </li>
                                    @endforeach
                                                ...
                                                <div class="offer-product">
                                                    <a href="{{ route('product.detail', ['id' => $product->id]) }}"
                                                        ...
                                                        <img src="/images/products/{{ $product->product_image }}"
                                                            alt="{{ $product->name }}" class="lazyload img-fluid">
                                                    </a>
                ...
                <div class="col-xxl-9 col-xl-8">
                    ...
                    <div class="title section-t-space">
                        <h2>Latest on Blog(it will be update in next time)</h2>
