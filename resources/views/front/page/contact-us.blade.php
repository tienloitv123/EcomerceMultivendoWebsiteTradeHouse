            ...
            <div class="col-12 col-xl-11">
              ...
              <div class="d-flex mb-5">
                ...
                <div>
                  ...
                  <p><strong>-></strong> {{ $settings->site_address ?? 'No address available' }}</p>
                 </div>
              </div>
              <div class="row mb-5">
                <div class="col-12 col-sm-6">
                  <div class="d-flex mb-5 mb-sm-0">
                    ...
                    <div>
                      ...
                      <p><strong>+</strong> {{ $settings->site_phone ?? 'No phone available' }}</p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="d-flex mb-0">
                    ...
                    <div>
                      ...
                      <p>{{ $settings->site_email ?? 'No email available' }}</p>
                    </div>
                  </div>
                </div>
              </div>
