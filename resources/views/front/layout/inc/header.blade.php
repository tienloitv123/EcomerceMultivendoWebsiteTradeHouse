<header class="bg-light border-bottom">
    ...
    <div class="bg-secondary text-white py-2">
        <div class="container d-flex justify-content-between align-items-center">
            <div class="text-dark">
                <i class="bi bi-geo-alt-fill text-dark" ></i> TP. Trà Vinh, P. 1, Trà Vinh
            </div>
            <div class="text-dark">
    ...
    <div class="container py-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="/" class="d-flex align-items-center">
                <img src="/images/site/{{ get_settings()->site_logo }}" alt="Logo" class="img-fluid" style="width: 120px;">
            </a>
                        ...
                        <ul class="user-box-name">
                            @if (auth('client')->check())
                                <li class="product-box-contain">
                                    <a href="{{ route('client.profile') }}"><i
                                            class="icon-copy dw dw-user-2"></i> Profile</a>
                                </li>
                                <li class="product-box-contain">
                            ...
                            @else
                                ...
                                <li class="product-box-contain">
                                    <a href="{{ route('admin.login') }}"><i
                                            class="icon-copy dw dw-login"></i> Admin Login</a>
                                </li>
                                <li class="product-box-contain">
                                    <a href="{{ route('seller.login') }}"><i
                                            class="icon-copy dw dw-login"></i> Login as a seller</a>
                                </li>
                            @endif
                        </ul>
                    </div>
...
.bg-secondary {
    background-color: #e5e5e5 !important; /* Nhẹ nhàng hơn */
}
